...
import com.jty.web.limit.dialect.Dialect;

@Intercepts({ @Signature(method = "prepare", type = StatementHandler.class, args = { Connection.class }) ,
    @Signature(method = "query", type = Executor.class, args = { MappedStatement.class, Object.class, RowBounds.class, ResultHandler.class }) })
public class MybatisLimit implements Interceptor {
    private static final Logger logger = LoggerFactory.getLogger(MybatisLimit.class);
    public static Dialect dialect;
//    private static DefaultObjectFactory defaultObjectFactory = new DefaultObjectFactory();
//    private static DefaultObjectWrapperFactory defaultObjectWrapperFactory = new DefaultObjectWrapperFactory();
...
//            MetaObject metaStatementHandler = MetaObject.forObject(invocation.getTarget(), defaultObjectFactory, defaultObjectWrapperFactory);
